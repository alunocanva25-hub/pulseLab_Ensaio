...
class LEDAIVerifier:
    ...
    def validate(self, target: dict | None):
        ...
        if color in {"VERMELHO", "AMARELO"}:
            ...
            # branco normalmente tem saturação baixa

            if brightness >= 180:

                confidence += 0.20

                reasons.append("branco brilhante")
        ...
        if circularity >= 0.25:
            ...
            reasons.append("forma aceitável")
